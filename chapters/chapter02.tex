...
\begin{figure}[htb!]
    ...
    \includegraphics[width=.3\linewidth]{chapter04/sham_mesh.png}}\quad
    \subfloat[AB]
    {\label{fig:ratrepgeom-b}
    \includegraphics[width=.3\linewidth]{chapter04/ab_mesh.png}}
    \caption{Rat representative cubic Hermite finite element meshes.}\label{fig:ratrepgeom}
\end{figure}
