%==============================================================================
\chapter{Encoding $\Ca$ transient variations to in silico map calcium pharmacological modulations to whole-organ function and to validate the fitted rat heart contraction model}\label{cha:chapter6}
%==============================================================================
%
%
%
...
\begin{figure}[!ht]
    ...
    \caption{LV pressure features' dose-response curves for the eight CiPA compounds. Simulated PeakP, maxdP and mindP features are given as percentages of the respective control values, and are displayed as dots in blue variants colour-coded with the drug doses. \todo{improve figure}}
