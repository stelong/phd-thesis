%==============================================================================
\chapter{Introducing and validation of calcium transient variation into the whole heart model}\label{cha:chapter6}
%==============================================================================
%
%
%
...
pharmacological channel blocking experimental validation 

    CiPA compounds' effects on $\Ca$ dynamics and how these propagate through to whole heart function (Section~\ref{sec:ch6validating_the_personalised_healthy_rat_heart_model}). We then provide a discussion and address specific limitations (Section~\ref{sec:ch6discussion}), and we conclude with a brief summary (Section~\ref{sec:ch6summary}).
\end{remark}
