...
\noindent
Gradient descent optimisation algorithms are commonly used \todo{REF} to minimise the objective function (or \textit{loss function})
%
\begin{equation}
