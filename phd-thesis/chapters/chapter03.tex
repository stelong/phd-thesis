...
\begin{description}
    ...
    \end{equation*}
    \item[\textsc{step 5.}] Unless a stopping criterion has been reached, refocus on the new $X_{NIMP}$ space, i.e. repeat from \textsc{step 1} using emulators trained on the new training dataset $T$, being these now more accurate in the non-implausible region.
\end{description}
