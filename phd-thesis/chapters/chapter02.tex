...
\begin{figure}[!ht]
    ...
    \caption{Main ion channels and pumps included in the Gattoni et al.~\cite{Gattoni:2016} model. \todo{improve}}
    \label{fig:gattonicurrentsfig}
\end{figure}


\todo{missing equations for all the currents (is it really needed?)}
