...
%% ANATOMY MODEL move LATER ON

%% START OF CHAPTER 2: figure with schematic from slides
% this is the overall schematic of the multiscale model

% concluding remarks for chapter 2 to reconnect to introduction